...
describe(endpointName, function () {
  describe(filename, function () {
    let sandbox,
      ...
      cascadingTarget = 'localhost.example.com/_layouts/validDeep',
    ...
    describe('/_layouts/:name', function () {
      const path = this.title;
    ...
    describe('/_layouts/:name/instances/:id@:version', function () {
      let path = this.title,
        version = 'scheduled';
    ...
    describe('/_layouts/:name/instances/:id/meta', function () {
      ...
      acceptsJsonBody(path, { name: 'valid', id: 'valid' }, {name: 'foo'}, 200, {name: 'foo'});
    });
  });
});
