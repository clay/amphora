...
describe(endpointName, function () {
  describe(filename, function () {
    ...
    describe('/pages/:name.html', function () {
      ...
      acceptsHtml(path, {name: 'valid'}, 200, '<valid>{"someArea":[{"_ref":"/components/valid","name":"Manny","species":"cat"}],"template":"layout"}</valid>');
    ...
    describe('/pages/:name@:version.html', function () {
      ...
      acceptsHtml(path, {name: 'valid', version: 'valid'}, 200, '<valid>{"someArea":[{"_ref":"/components/valid","name":"Manny","species":"cat"}],"template":"layout"}</valid>');
