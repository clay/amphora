...
module.exports = function () {
  ...
  // Return null because no values from the boostrapping
  // are used in the next instantiation steps, but returning
  // a value here affects how we connect to Elastic Search
};
