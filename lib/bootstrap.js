...
// , promisePagesOps, promiseUrisOps, promiseListsOps
// , pagesOps, urisOps, listsOps
  return bluebird.join(promiseComponentsOps, function (componentsOps) {
    const flatComponentsOps = _.flatten(componentsOps),
      ops = flatComponentsOps;
