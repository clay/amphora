...
describe(_.startCase(filename), function () {
  ...
  beforeEach(function () {
    ...
    lib.safeFileExists.cache = new _.memoize.Cache();
  ...
  describe('getComponents', function () {
    ...
    it('gets a list of npm components', function () {
      ...
      expect(fn()).to.contain('byline-c3', 'byline-c4');
    });
  });
  ...
  describe('getComponentPath', function () {
    ...
    beforeEach(function () {
      ...
      lib.getComponents.returns(['c1', 'byline-c5', 'byline-c3']);
      fs.existsSync.returns(false);
      fs.existsSync.withArgs('components/c1').returns(true);
      fs.existsSync.withArgs('node_modules/byline-c3').returns(true);
      fs.existsSync.withArgs('node_modules/@a/byline-c5').returns(true);
      path.resolve.withArgs('components', 'c1').returns('components/c1');
      path.resolve.withArgs('node_modules', 'byline-c3').returns('node_modules/byline-c3');
      path.resolve.withArgs('node_modules', '@a/byline-c5').returns('node_modules/@a/byline-c5');
    });
