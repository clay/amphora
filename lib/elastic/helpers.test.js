...
describe(_.startCase(filename), function () {
  describe(filename, function () {
    ...
    describe('removeEmptyValuesForProperty', function () {
      let fn = lib[this.title];

      it('removes null property values', function () {
        let func = fn('nullProp'),
          ops = [{
            type: 'put',
            key: 'localhost/components/foo/instances/xyz',
            value: {nullProp: null, stringProp: 'Hello'}
          }],
          expectedResult = [{
            type: 'put',
            key: 'localhost/components/foo/instances/xyz',
            value: { stringProp: 'Hello' }
          }];

        expect(func(ops)).to.deep.equal(expectedResult)
      });

      it('removes undefined property values', function () {
        let func = fn('undefinedProp'),
          ops = [{
            type: 'put',
            key: 'localhost/components/foo/instances/xyz',
            value: {undefinedProp: undefined, stringProp: 'Hello'}
          }],
          expectedResult = [{
            type: 'put',
            key: 'localhost/components/foo/instances/xyz',
      ...
      it('does nothing if the value is defined', function () {
        let func = fn('stringProp'),
          ops = [{
            type: 'put',
            key: 'localhost/components/foo/instances/xyz',
            value: { stringProp: 'Hello' }
    ...
    describe('resolveReferencesForPropertyOfStringType', function () {
      ...
      it('resolves the reference to a component if one is included', function () {
        let func = fn('content'),
          ops = [{
            type: 'put',
            key: 'localhost/components/foo/instances/xyz',
            value: { content: { _ref: 'localhost/components/bar/instances/xyz'} }
          }],
          expected = [{
            type: 'put',
            key: 'localhost/components/foo/instances/xyz',
        ...
        db.get.returns(bluebird.resolve('{"items": []}'));
