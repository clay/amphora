...
describe(_.startCase(filename), function () {
  describe(filename, function () {
    ...
    describe('isOpForInstance', function () {
      ...
      it('takes an operation and returns false if its key is\'nt an article component ref', function () {
        let op = {
          type: 'put',
    ...
    describe('isOpForPut', function () {
      ...
      it('takes an operation and returns false if its key is\'nt a put operation', function () {
        let op = {
          type: 'get',
          key: 'www.vulture.com/components/sailthru-personalization-pixel',
          value: '{}'
    ...
    describe('isPublished', function () {
      ...
      it('takes an operation and returns false if its key does\'nt have a published ref', function () {
        let op = {
          type: 'get',
          key: 'www.vulture.com/components/sailthru-personalization-pixel',
          value: '{}'
    ...
    describe('isScheduled', function () {
      ...
      it('takes an operation and returns false if its key does\'nt have a scheduled ref', function () {
        let op = {
          type: 'get',
          key: 'www.vulture.com/components/sailthru-personalization-pixel',
          value: '{}'
