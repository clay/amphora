...
// when any put or batch is made, expose it to the outside only if it is a success; also: never block for them
_.each(['put', 'batch'], function (key) {
  module.exports[key] = _.wrap(module.exports[key], function (fn) {
    ...
    if (_.isObject(result) && _.isFunction(result.then)) {
      result.then(function () {
        module.exports.trigger.apply(module.exports.trigger, [key].concat(args));
