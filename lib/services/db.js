...
_.each(['put', 'batch', 'del'], function (method) {
  module.exports[method] = _.wrap(module.exports[method], function (fn) {
    ...
    return result.then(function (result) {
      ...
      const firstBatchOp = _.get(args, '[0][0]'),
        firstKey = method === 'batch' ? _.get(firstBatchOp, 'key') : args[0],
        firstType = method === 'batch' ? _.get(firstBatchOp, 'type') : method;
      ...
      switch (firstType) {
        ...
        default:
          ...
          if (_.endsWith(firstKey, publishedVersionSuffix)) {
