...
//   //     return fn('/_pages/key@published','val').then(() => {
//   //       expect(plugins.executeHook.firstCall.args).to.deep.equal([
//   //         'save', [{type: 'put', key: '/_pages/key@published', value: 'val'}]
//   //       ]);
...
//   //     const ops = [
//   //       {type: 'put', key: '/_pages/key@published', value: 'val'}
//   //     ];
//   //
//   //     return fn(ops).then(() => {
//   //       expect(plugins.executeHook.firstCall.args).to.deep.equal([
...
//   //     });
//   //   });
//   //   it('executes publish plugin hooks for page publish batch', function () {
//   //     const ops = [
...
//   //     on = _.noop;
//   //     on.on = on;
//   //     sandbox.stub(lib.getDB(), 'createReadStream').callsFake(_.constant(on));
