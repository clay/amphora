...
function pickPageMeta(data) {
  return _.pick(data, ['createdAt', 'archived', 'published', 'scheduled', 'scheduledTime', 'publishTime', 'updateTime', 'firstPublishTime', 'url', 'title', 'authors', 'users', 'history', 'slug']);
}
...
module.exports.pickPageMeta = pickPageMeta;
