...
function swapOutAllUrisJson(site) {
  return function (json) {
    var { slug, host, path } = site,
      prefixString = `"_ref":"${path && path.length > 1 ? `${host}${path}` : host}/_components/`,
      searchString = `"_ref":"${slug}/_components/`,
...
function swapInAllUrisJson(json, site) {
  var { slug, host, path } = site,
    sitePrefix = path && path.length > 1 ? `${host}${path}` : host,
    prefixString = `"_ref":"${sitePrefix}/_components/`,
    replaceString = `"_ref":"${slug}/_components/`,
...
//  * @returns {function}
//  */
// function swapInAllUris(data, site) {
//   _.each(listDeepObjects(data, '_ref'), function (obj) {
//     obj._ref = uriSwapInSlug(obj._ref, site);
//   });
//   return data;
// }
//
...
//  * @returns {function}
//  */
// function swapOutAllUris(data, site) {
//   _.each(listDeepObjects(data, '_ref'), function (obj) {
//     obj._ref = uriSwapOutSlug(obj._ref, site);
//   });
//   return data;
// }
...
module.exports.swapOutAllUrisJson = swapOutAllUrisJson;
module.exports.swapInAllUrisJson = swapInAllUrisJson;
