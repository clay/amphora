...
// Reference to the ES client & ES index Prefix
var client, indexPrefix;
...
function createInternalIndices() {
  var dirPath = path.resolve(__dirname, '../elastic/mappings'),
    internalMappings = module.exports.retrieveMappingData(dirPath, indexPrefix);

  return module.exports.validateIndices(internalMappings)
    .then(pageList.sitesIndex)
    .then(function () {
...
module.exports.createInternalIndices = createInternalIndices;
