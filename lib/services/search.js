...
module.exports = {
 ...
 /**
  ...
  batchDBFormat: function (ops) {
    const searchOps = _.map(this.mapSearchBatchOps(ops), function (op) {
      return {
        index: op.index,
        type: op.indexType,
        doc: toJson(op.value),
