...
function initIndex(index, mappings) {
  return module.exports.client.indices.create({
    index: index,
    body: mappings
  }).then(function () {
...
function existsIndex(index) {
  return module.exports.client.indices.exists({
    index: index
  });
}
 ...
 * Append the `aliasSuffix` to newly created indices
 *
 * @param {string} alias
 * @returns {string}
 */
...
function delIndex(index) {
  return module.exports.client.indices.delete({
    index: index
  }).then(function () {
...
function initAlias(name, index) {
  return module.exports.client.indices.putAlias({
    name: name,
    index: index
  });
}
...
function existsAlias(name) {
  return module.exports.client.indices.existsAlias({
    name: name
  });
}
...
function initMapping(index, type, mapping) {
  return module.exports.client.indices.putMapping({
    index: index,
    type: type,
    body: mapping
  }).then(function () {
...
function existsMapping(index, type) {
  return module.exports.client.indices.getMapping({
    index: index,
    type: type
  });
}
...
function query(index, query, type) {
  return module.exports.client.search({
    index: index,
    type: type,
    body: query
  })
...
function put(index, type, ref, source) {
  return module.exports.client.index({
    index: index,
    type: type,
    id: ref,
    body: source
...
function del(index, type, ref) {
  return module.exports.client.delete({
    index: index,
    type: type,
    id: ref
  }).then(function (resp) {
 ...
 */
function batch(ops) {
  return module.exports.client.bulk({
    body: ops
  }).then(function (resp) {
...
function setup(overrideClient) {
  module.exports.client = module.exports.endpoint || !overrideClient ? new es.Client(serverConfig) : _.assign({}, overrideClient);
}

/**
 * Sets the alias suffix for use
 * @param {[type]} suffix [description]
 */
function setAliasSuffix(suffix) {
  if (_.isString(suffix)) {
    aliasSuffix = suffix;
  } else {
    throw new Error('Alias suffix required to be a string');
  }
}

module.exports.setup = setup;
module.exports.setAliasSuffix = setAliasSuffix;
...
module.exports.overrideClient = function (overrideClient) {
  module.exports.client = _.assign(module.exports.client, overrideClient);
};
