    ...
    return components.get(referenceObject[referenceProperty], locals)
      .then(function (obj) {
        ...
        return resolveComponentReferences(obj, locals, filter).finally(function () {
          ...
          referenceObject[referenceProperty] = componentUri.indexOf(`${locals.site.slug}/_`) > -1 ? references.uriSwapOutSlug(componentUri, locals.site) : componentUri;
...
function composePage(pageData, locals) {
  ...
  return components.get(references.uriSwapInSlug(layoutReference, locals.site), locals, false)
