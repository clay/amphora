...
describe(_.startCase(filename), function () {
  ...
  beforeEach(function () {
    ...
    lib.overrideClient(client); // Set the client object
    sandbox.stub(client);
  ...
  describe('init', function () {
    ...
    it('returns undefined if ELASTIC_HOST is undefined', function () {
      expect(lib()).to.be.undefined;
    });

    it('returns an instance of the ES Client', function () {
      lib.endpoint = 'whatever';

      expect(lib()).to.not.be.an.undefined;
    });
  });
  ...
  // delIndex
  describe('delIndex', function () {
    var fn = lib[this.title];

    it('is called successfully', function () {
      client.indices.delete.returns(Promise.resolve(true));
      return fn('index')
        .then(function() {
          expect(client.indices.delete.calledOnce).to.be.true;
        });
    });

    it('handles successful queries', function () {
      client.indices.delete.returns(Promise.resolve('delIndex successfull'));
      return fn('index')
        .then(function() {
    ...
    it('handles failed queries', function () {
      client.indices.delete.returns(Promise.reject(false));
      return fn('index')
        .catch(function (resp) {
  ...
  describe('initIndex', function () {
    ...
    it('handles error properly', function () {
      client.indices.create.returns(Promise.reject('create indices error'));
      return fn('index', 'mappings')
        .then(function() {
          expect(client.indices.create.calledOnce).to.be.true;
        });
  ...
  describe('initAlias', function () {
    ...
    it('handles error properly', function () {
      client.indices.putAlias.returns(Promise.reject('create indices error'));
      return fn('name', 'index')
        .catch(function () {
          expect(client.indices.putAlias.calledOnce).to.be.true;
        });
  ...
  describe('query', function () {
    ...
    it('calls the search method provided by the ES client', function () {
      client.search.returns(Promise.resolve('ES Client `search` called'));
