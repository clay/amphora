...
describe(_.startCase(filename), function () {
  ...
  describe('createIndexName', function () {
    ...
    it('returns a string', function () {
      expect(fn('alias')).be.equal('alias');
    });
  });
  ...
  // setAliasSuffix
  describe('setAliasSuffix', function () {
    var fn = lib[this.title];
    ...
    it('sets the aliasSuffix if one is passed in', function () {
      fn('_example');

      expect(lib.createIndexName('alias')).to.equal('alias_example');
    });
