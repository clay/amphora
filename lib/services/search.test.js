...
describe(_.startCase(filename), function () {
  ...
  // setIndexVersion
  describe('setIndexVersion', function () {
    var fn = lib[this.title];

    it('checks that a string is passed in as an argument', function () {
      var result = function () {
        fn();
      };
    ...
    it('checks that a string is properly formatter with "_v"', function () {
      var result = function () {
        fn('hello');
      };
    ...
    it('sets the indexVersion if a proper value is passed in', function () {
      fn('_v34');
      expect(lib.createIndexName('alias')).to.equal('alias_v34');
    });
  });
});
