  ...
  describe('publish', function () {
    ...
    it('warns if publish is slow', function () {
      ...
      return fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/_components/thing'},
        ...
        sinon.assert.calledWith(winston.log, 'warn', sinon.match('slow publish domain.com/path/_pages/thing@published 700ms'));
      });
    });
    ...
    it('logs if publish is not slow', function () {
      ...
      return fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/_components/thing'},
        ...
        sinon.assert.calledWith(winston.log, 'info', sinon.match('published domain.com/path/_pages/thing 20ms'));
      });
    });
