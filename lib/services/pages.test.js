...
describe(_.startCase(filename), function () {
  ...
  describe('publish', function () {
    ...
    it('creates relevant uri', function () {
      ...
      return fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/components/thing'},
        {
          site: {
    ...
    it('throws on empty data', function (done) {
      ...
      fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/components/thing', head: ['']}, { site: {} })
        .then(done)
    ...
    it('throws when a sites publishing chain does not provide a url', function (done) {
      ...
      fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/components/thing'},
