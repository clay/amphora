  ...
  describe('publish', function () {
    ...
    it('throws when a sites publishing chain does not provide a url', function () {
      ...
      return fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/_layouts/thing'}, { site: {} })
        .catch(function (result) {
          expect(result.message).to.equal('Unable to determine a url for publishing domain.com/path/_pages/thing');
        });
    });
    ...
    it('throws when a site does not provide a resolvePublishing function to modify the publishing chain', function (done) {
      ...
      fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/_layouts/thing'},
        {
          site: {}
        }).then(done)
        .catch(function (result) {
