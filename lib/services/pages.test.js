...
describe(_.startCase(filename), function () {
  ...
  describe('create', function () {
    ...
    it('creates without content', function () {
      ...
      return fn('domain.com/path/pages', {layout: 'domain.com/path/_components/thing'}).then(function (result) {
  ...
  describe('publish', function () {
    ...
    it('warns if publish is slow', function () {
      ...
      return fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/_components/thing'},
        ...
        sinon.assert.calledWith(logFn, 'warn', sinon.match('slow publish domain.com/path/_pages/thing@published 700ms'));
      });
    });
    ...
    it('logs if publish is not slow', function () {
      ...
      return fn('domain.com/path/_pages/thing@published', {layout: 'domain.com/path/_components/thing'},
        ...
        sinon.assert.calledWith(logFn, 'info', sinon.match('published domain.com/path/_pages/thing 20ms'));
      });
    });
    ...
    it('warns if notification fails', function () {
      ...
      return fn(uri, {layout: 'domain.com/path/_components/thing'},
        ...
        sinon.assert.calledWith(logFn, 'warn');
        sinon.assert.calledTwice(logFn); // it's called once with info
      });
    });
