...
describe(_.startCase(filename), function () {
  ...
  describe('publish', function () {
    ...
    it('creates relevant uri', function () {
      var pageData = {layout: 'domain.com/path/_components/thing'};
    ...
    it('warns if notification fails', function () {
      const site = {},
        ...
        pageData = {layout: 'domain.com/path/_components/thing'};
    ...
    it('throws on empty data', function (done) {
      var pageData = {layout: 'domain.com/path/_components/thing', head: ['']};
    ...
    it('publishes without provided data', function () {
      ...
      components.get.returns(bluebird.resolve({}));
      db.get.returns(bluebird.resolve({layout: 'domain.com/path/_components/thing', url: 'http://some-domain.com'}));
      db.batch.returns(bluebird.resolve());
      siteService.getSiteFromPrefix.returns({notify: _.noop});
      notifications.notify.returns(bluebird.resolve());

      publishService.resolvePublishUrl.returns(Promise.resolve(pageData));
