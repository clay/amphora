...
function getSites() {
  ...
  files.getFolders(instanceSitesFolder).forEach(function (site) {
    ...
    siteConfig.path = siteConfig.path ? normalizePath(siteConfig.path) : '';
    siteConfig.dir = dir;
    siteConfig.assetPath =  siteConfig.assetPath ? normalizePath(siteConfig.assetPath) : ''; // assetPath can be blank
