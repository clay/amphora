...
describe(_.startCase(filename), function () {
  ...
  describe('get', function () {
    ...
    it('gets using component model', function () {
      ...
      db.get.returns(bluebird.resolve(JSON.stringify({a: 'b'})));
      upgrade.init.returns(bluebird.resolve({a: 'b'}));
    ...
    it('blocks component model returning non-object', function (done) {
      ...
      db.get.returns(bluebird.resolve(JSON.stringify({})));
    ...
    it('gets using component model with locals', function () {
      ...
      db.get.returns(bluebird.resolve(JSON.stringify(data)));
