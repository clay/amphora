...
let log = require('./services/logger').setup({ file: __filename }),
  amphoraAuthentication = require('amphora-authentication');
...
function addAuthenticationRoutes(router) {
  ...
  amphoraAuthentication.addRoutes(authRouter);
...
module.exports.setamphoraAuthentication = mock => amphoraAuthentication = mock;
