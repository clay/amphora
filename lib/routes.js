...
const _ = require('lodash'),
  ...
  attachMiddleware = require('./services/attachMiddleware'),
...
function addSiteController(router, site, providers) {
  if (site.dir) {
    ...
    if (controller) {
      ...
      if (_.isArray(controller.middleware)) {
        attachMiddleware(router, controller.middleware);
      }
      ...
      _.assign(site, _.pick(controller, ['resolvePublishing', 'resolvePublishUrl', 'modifyPublishedData']));
    }
  }
