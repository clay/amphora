...
function combineStyles(stylesArr) {
  ...
  var allPromises = getContentsOfFiles(stylesArr, 'public/css', '/css/');
...
function combineScripts(scriptsArr) {
  ...
  var allPromises = getContentsOfFiles(scriptsArr, 'public/js', '/js/');
...
function append(data) {
  ...
  return function (html) {
    ...
    var stylesPromise = combineStyles(mediaMap.styles),
