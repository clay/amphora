...
let route = _.bindAll({
  ...
  get: function (req, res) {
    responses.expectJSON(function () {
      console.log('get', req.hostname + req.baseUrl + req.url, responses.getUri(req));
      return controller.get(responses.getUri(req));
    }, res);
  },
  ...
  put: function (req, res) {
    responses.expectJSON(function () {
      return controller.put(responses.getUri(req), req.body);
    }, res);
  },
  ...
  del: function (req, res) {
    responses.expectJSON(function () {
      return controller.del(responses.getUri(req));
    }, res);
  },
  ...
  post: function (req, res) {
    responses.expectJSON(function () {
      return controller.post(responses.getUri(req), req.body);
    }, res);
  },
  ...
  schema: function (req, res) {
    responses.expectJSON(function () {
      return controller.getSchema(responses.getUri(req));
    }, res);
  },

  render: function (req, res) {
    responses.expectHTML(function () {
      return composer.renderComponent(responses.getUri(req), res, _.pick(req.query, queryStringOptions));
    }, res);
  }
});
