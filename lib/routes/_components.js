...
route = _.bindAll({
   ...
   */
  del(req, res) {
    responses.expectJSON(() => controller.del(req.uri, res.locals), res);
  },
   ...
   */
  schema(req, res) {
    responses.expectJSON(() => controller.getSchema(req.uri), res);
  },
...
function routes(router) {
  ...
  router.delete('/:name/instances/:id@published', route.del);
