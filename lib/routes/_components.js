...
function routes(router) {
  ...
  router.get('/:name/instances', responses.listAndSwapPrefix);
  ...
  router.get('/:name/instances/:id@:version.:ext', route.get);
  // Layouts can be scheduled
  router.put('/:name/instances/:id@scheduled', responses.denyReferenceAtRoot);
  router.put('/:name/instances/:id@scheduled', withAuthLevel(authLevels.WRITE));
  router.put('/:name/instances/:id@scheduled', route.put);
  ...
  router.delete('/:name/instances/:id@scheduled', withAuthLevel(authLevels.WRITE));
  router.delete('/:name/instances/:id@scheduled', route.del);
