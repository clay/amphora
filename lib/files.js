...
let _ = require('lodash'),
  ...
  { getComponents, getLayouts, getComponentPath, getLayoutPath, getYaml } = require('amphora-fs'),
...
function getLayoutModule(name, prefix) {
  ...
  componentPath = module.exports.getLayoutPath(name);
...
exports.getComponents = getComponents; // Memoized in the package so other packages in the same instance get the benefits without bloating memory
exports.getLayouts = getLayouts; // Memoized in the package so other packages in the same instance get the benefits without bloating memory
exports.getComponentPath = _.memoize(getComponentPath);
exports.getLayoutPath = _.memoize(getLayoutPath);
exports.getComponentModule = _.memoize(getComponentModule, (name, prefix) => `${name}${prefix ? `|${prefix}` : ''}`);
exports.getLayoutModule = _.memoize(getLayoutModule, (name, prefix) => `${name}${prefix ? `|${prefix}` : ''}`);
