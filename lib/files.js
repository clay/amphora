...
const IGNORED_CLAY_MODULES = [
  'clay-log',
  'clay-sitemaps'
]; // We don't ignore Kiln here because it is a component and that would break things
...
function getComponentPath(name) {
  ...
  // make sure it's a component we have (either in /_components or package.json)
