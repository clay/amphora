...
function renderTemplate() {
  return function (data) {
    //assertions
    is.object(data, 'renderTemplate');
    is.string(data.template, 'data.template');
...
function renderPage(ref, res) {
  ...
  return db.get(ref)
    ...
    .then(function (result) {
      ...
      console.log('renderPage pageData', pageData, 'layoutReference', replaceVersion(layoutReference, version));

      return components.get(replaceVersion(layoutReference, version))
        .then(mapLayoutToPageData.bind(this, pageData))
        .then(function (result) {

          console.log('renderPage components.get', result);
