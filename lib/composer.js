...
function renderTemplate() {
  return function (data) {
    ...
    return multiplex.render(components.getTemplate(data.template), data);
  };
}
...
function renderComponent(componentReference, res, options) {
  ...
  var componentName = is(components.getName(componentReference), 'component name');

  return components.get(componentReference, res.locals)
    .then(function (data) {
      //assertions
      is.object(data);
